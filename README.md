...
-----
                ...
                [ VirtualBox - Réseau interne : Lan-Test ]
─────────────────────────────────────────────────────────────
              192.168.100.20                  192.168.100.10
            ┌────────────────┐            ┌────────────────────┐
            │ Parrot OS      │  ⇄  ICMP  │ Debian 12/13        │
            │ (Attaquant)    │  ⇄  HTTP  │ (Victime / Docker)  │
            │  - curl, nmap  │           │  - Juice Shop (port 3000)
            │  - Python tool │           │  - Docker Engine     │
            └────────────────┘            └────────────────────┘
                                                 │
                                                 │ Port 3000
                                                 ▼
                                      ...
                                      └─────────────────────┘
─────────────────────────────────────────────────────────────
              🔒 Réseau interne isolé (aucun accès Internet)
